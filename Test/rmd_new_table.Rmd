...
<div class='fragment fade-in' style='position:absolute;height:37.5%;width:25%;top:0%;left:0%;background-color:#0f0;border:solid;border-width:1px;border-radius:5px;padding:10px;'>
<h2> Om statistik </h2>

</div>
<div class='fragment fade-in' style='position:absolute;height:37.5%;width:25%;top:0%;left:33.33%;background-color:#0f0;border:solid;border-width:1px;border-radius:5px;padding:10px;'>
<h2> Skeende och brus </h2>
...
<div class='fragment fade-in' style='position:absolute;height:37.5%;width:25%;top:0%;left:66.67%;background-color:#0f0;border:solid;border-width:1px;border-radius:5px;padding:10px;'>
<h2> Populationsbegreppet </h2>
...
<div class='fragment fade-in' style='position:absolute;height:37.5%;width:25%;top:50%;left:0%;background-color:#0f0;border:solid;border-width:1px;border-radius:5px;padding:10px;'>
<h2> Stickprov </h2>
...
<div class='fragment fade-in' style='position:absolute;height:37.5%;width:25%;top:50%;left:33.33%;background-color:#0f0;border:solid;border-width:1px;border-radius:5px;padding:10px;'>
<h2>  </h2>
...
<div class='fragment fade-in' style='position:absolute;height:37.5%;width:25%;top:50%;left:66.67%;background-color:#0f0;border:solid;border-width:1px;border-radius:5px;padding:10px;'>
<h2> Experiment </h2>
...
<div class='fragment fade-in' style='position:absolute;height:37.5%;width:25%;top:0%;left:0%;background-color:#0f0;border:solid;border-width:1px;border-radius:5px;padding:10px;'>
<h2> Replikat och pseudoreplikat </h2>
...
<div class='fragment fade-in' style='position:absolute;height:37.5%;width:25%;top:0%;left:66.67%;background-color:#0f0;border:solid;border-width:1px;border-radius:5px;padding:10px;'>
<h2> Beskrivande statistik </h2>

</div>
<div class='fragment fade-in' style='position:absolute;height:37.5%;width:25%;top:50%;left:0%;background-color:#0f0;border:solid;border-width:1px;border-radius:5px;padding:10px;'>
<h2> Statistisk variabel </h2>

En mätbar egenskap som varierar mellan individer

</div>
<div class='fragment fade-in' style='position:absolute;height:37.5%;width:25%;top:50%;left:33.33%;background-color:#0f0;border:solid;border-width:1px;border-radius:5px;padding:10px;'>
<h2> Taxologi för variabler </h2>
...
<div class='fragment fade-in' style='position:absolute;height:37.5%;width:25%;top:50%;left:66.67%;background-color:#0f0;border:solid;border-width:1px;border-radius:5px;padding:10px;'>
<h2> Taxologi för variabler, skaltyper </h2>
...
<div class='fragment fade-in' style='position:absolute;height:37.5%;width:25%;top:50%;left:33.33%;background-color:#0f0;border:solid;border-width:1px;border-radius:5px;padding:10px;'>
<h2> Punktskattningar </h2>

</div>
<div class='fragment fade-in' style='position:absolute;height:37.5%;width:25%;top:50%;left:66.67%;background-color:#0f0;border:solid;border-width:1px;border-radius:5px;padding:10px;'>
<h2> Läge och spridning </h2>
...
<div class='fragment fade-in' style='position:absolute;height:75%;width:25%;top:0%;left:0%;background-color:#0f0;border:solid;border-width:1px;border-radius:5px;padding:10px;'>
<h2> Histogram </h2>
...
<div class='fragment fade-in' style='position:absolute;height:75%;width:25%;top:0%;left:33.33%;background-color:#0f0;border:solid;border-width:1px;border-radius:5px;padding:10px;'>
<h2> Venn-diagram </h2>
...
<div class='fragment fade-in' style='position:absolute;height:75%;width:25%;top:0%;left:66.67%;background-color:#0f0;border:solid;border-width:1px;border-radius:5px;padding:10px;'>
