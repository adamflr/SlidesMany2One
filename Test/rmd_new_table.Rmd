...
<div class='fragment fade-in' style='position:absolute;height:75%;width:37.5%;top:0%;left:0%;background-color:#0f0;border:solid;border-width:1px;border-radius:5px;padding:10px;'>
<h2> Om statistik </h2>

</div>
<div class='fragment fade-in' style='position:absolute;height:75%;width:37.5%;top:0%;left:50%;background-color:#0f0;border:solid;border-width:1px;border-radius:5px;padding:10px;'>
